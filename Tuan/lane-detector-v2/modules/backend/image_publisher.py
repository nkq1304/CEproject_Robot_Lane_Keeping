...
class ImagePublisher:
    ...
    @staticmethod
    def __init__():
        ImagePublisher.image_transform = rospy.Publisher("/image_transform", Image, queue_size=10)
        ImagePublisher.perspective_transform = rospy.Publisher("/perspective_transform", Image, queue_size=10)
        ImagePublisher.lane_fitting = rospy.Publisher("/lane_fitting", Image, queue_size=10)
        ImagePublisher.lane_detector = rospy.Publisher("/lane_detector", Image, queue_size=10)
        ImagePublisher.lane_tracking = rospy.Publisher("/lane_tracking", Image, queue_size=10)

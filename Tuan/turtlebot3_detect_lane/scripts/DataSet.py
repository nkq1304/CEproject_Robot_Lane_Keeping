...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, transform=None, valid=False):
        ...
        self.valid = valid
        if valid:
            self.root = "/home/phox/catkin_ws/src/turtlebot3_detect_lane/scripts/data/bdd100k/images/val"
            self.names = os.listdir(self.root)
        else:
            self.root = "/home/phox/catkin_ws/src/turtlebot3_detect_lane/scripts/data/bdd100k/images/train"
            self.names = os.listdir(self.root)
    ...
    def __getitem__(self, idx):
        ...
        label1 = cv2.imread(
            image_name.replace("images", "segments").replace("jpg", "png"), 0
        )
        label2 = cv2.imread(
            image_name.replace("images", "lane").replace("jpg", "png"), 0
        )
        if not self.valid:

...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_workers", type=int, default=12, help="No. of parallel threads"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
        default=16,
        help="Batch size. 12 for ESPNet-C and 6 for ESPNet. "
    ...
    parser.add_argument(
        "--savedir", default="./test_", help="directory to save the results"
    )
    parser.add_argument(
        "--resume",
        type=str,
